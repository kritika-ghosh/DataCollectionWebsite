...
with gr.Blocks(theme=burnout_theme, css=custom_css) as demo:
    ...
    with gr.Row(elem_classes=["hero-section"]):
        with gr.Column(elem_classes=["hero-text-container"]):
            ...
            gr.Markdown('<p class="hero-subtitle">Move beyond simple questionnaires. Our system provides a comprehensive, objective analysis of your well-being by harnessing the power of multimodal AI. It intelligently combines real-time analysis of facial micro-expressions, vocal sentiment, and a clinical questionnaire to detect early signs of burnout with unprecedented accuracy. Designed for students and professionals facing immense pressure, it delivers personalized insights you can trust. Take control of your mental health with a tool that understands the unseen strain. Proactively manage your stress and prevent burnout before it becomes overwhelming.</p>')
        with gr.Column(elem_classes=["hero-image-container"]):
            gr.Image("https://placehold.co/400x550/e5989b/fff?text=Hero+Image", elem_classes="hero-image")
